	...
	<div class="post-input-wrap">
		...
		<ul class="clearfix">
			<li class="note-contact-item fl">
				...
				<input type="text" style="width:85px;" id="note-contact-phone" name="mobile" placeholder="请填写手机号码" validate="required:true,mobile:true,minlength:2, maxlength:40"/>
			</li>
			<li class="note-info-item fr">			
				<label for="note-contact-qq">您的QQ：</label>

				<input type="text" id="note-contact-qq" name="qq" placeholder="qq、手机请至少填写一个"/>
			</li>
