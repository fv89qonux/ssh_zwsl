...
<body width="100%"><div id="loader" >页面加载中...</div><div id="result" class="result none"></div><div class="mainbox"><div id="nav" class="mainnav_title"><ul>
	...
	<tr><td>原来密码</td><td><input type="password" class="input-text"  name="oldpassword" value="" ></td></tr>
	<tr><td>新设密码</td><td><input type="password" class="input-text"  name="password" value="" ></td></tr>
	<tr><td>再来一次</td><td><input type="password" class="input-text"  name="repassword" value="" ></td></tr>
